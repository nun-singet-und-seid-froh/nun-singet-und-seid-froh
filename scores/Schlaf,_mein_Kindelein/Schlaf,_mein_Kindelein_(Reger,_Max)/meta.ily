...
opus                    = "Zwölf deutsche geistliche Gesänge" 
noInOpus                = "4"
titleInOpus             = "Weihnachtslied"

lastEdited              = "3. März 2016" % e.g. "19. September 2015"
vers                    = "0.0.0" % write "0.0.0" for the first draft
noInNsusf               = "C" % write "X" as long piece is not ready to be published

% other meta-data, used for the MediaWiki-output
epoque                  = "Romantik" 
language                = "deutsch" 
instrumentation         = "SSATB" % "SATB", "SSAATTBB", etc.
