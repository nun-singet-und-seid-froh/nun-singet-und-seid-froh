...
arrangerChristianName   = "Robert Lucas" % e.g. "Johann Sebastian"
arrangerSurName	        = "Pearsall" % e.g. "Bach"
arrangerLifedata        = "1795-1856" % e.g. "1685-1750"
arrangementDate         = ""
...
noInNsusf               = "19" % write "X" as long piece is not ready to be published

% other meta-data, used for the MediaWiki-output
epoque                  = "" 
language                = "englisch / latein" 
instrumentation         = "SSAATTBB" % "SATB", "SSAATTBB", etc.
