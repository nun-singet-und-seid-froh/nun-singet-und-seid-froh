...
title                   = "Immanuel, der Herr ist hier"
...
arrangementDate         = "1901"

% poet is the one who wrote (the main part of) the lyrics (also see translator)
poetChristianName       = "Heinrich Cornelius" % e.g. "Paul"
poetSurName             = "Hecker" % e.g. "Gerhardt"
poetLifedata            = "1699-1743" % e.g. "1607-1676"
textDate                = ""
...
opus                    = "Der Evangelische Kirchenchor" 
noInOpus                = "4"
titleInOpus             = ""

lastEdited              = "4. August 2017" % e.g. "19. September 2015"
vers                    = "1.0.0" % write "0.0.0" for the first draft
noInNsusf               = "12" % write "X" as long piece is not ready to be published
